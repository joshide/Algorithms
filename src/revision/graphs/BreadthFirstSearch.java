...
public class BreadthFirstSearch {
	...
	private static LinkedList<GraphNode> getLinkedList(GraphNode node) {
		for(int i = 0; i < adjacencyList.length; i++) {
